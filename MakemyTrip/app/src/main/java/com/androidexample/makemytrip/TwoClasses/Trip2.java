...
public class Trip2 extends ActionBarActivity implements TripAdapter.ClickListener, TripAdapter2.ClickListener {

    private String url ="http://broado-server.herokuapp.com/travelApi?location=";//perfect
    private String TAG ="Eventparsing";
    private JSONObject jsonObject;
    private JSONArray jsonArray;
    private TripAdapter2 adapter;//static-->all objects
    private String[] name;
    private String[] end;
    ...
    private void getjsonData(JSONObject jsonobj) throws JSONException {
        ...
        List<TripInfo2> data = new ArrayList<>();

        for (int j = 0; j < distance.length; j++) {//two as of now
            TripInfo2 current = new TripInfo2();
        ...
        adapter = new TripAdapter2(this,data);
